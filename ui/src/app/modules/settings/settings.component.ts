...
export class SettingsComponent implements OnInit {
  ...
  public dummyEnableHttps: 'off' | 'keycert' | 'pfx' = 'off'
  ...
  ngOnInit() {
    ...
    this.dummyEnableHttps = this.uiSslKeyFormControl.value || this.uiSslCertFormControl.value
      ? 'keycert'
      : (this.uiSslPfxFormControl.value || this.uiSslPassphraseFormControl.value) ? 'pfx' : 'off'
    this.uiSslKeyFormControl.valueChanges.subscribe((value: string) => {
      switch (value) {
        case 'keycert':
